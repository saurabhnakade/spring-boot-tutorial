...
Inside a Transactional , if we make any changes to data , at the end of transaction , any changes to data gets synced with the DB , even if we do not make a explicit save call
